...
import data_visualisation.visualise_capacity_2sets
import os
...
if __name__ == "__main__":
    ...
    file_type = 'yaml'
    visualisation = data_visualisation.visualise_capacity_2sets.VisualiseCapacity(data_path, data_folder_list, file_type, N_ITERATION)
